...
struct SensorModel
{
  ...
  float azimuth_min_rad{-0.785398163F};
  float azimuth_max_rad{0.785398163F};
  float elevation_min_rad{-0.785398163F};
  float elevation_max_rad{0.785398163F};
...
private:
  ...
  struct Projection
  {
    ...
    float range{0.0F};
    float center_score{std::numeric_limits<float>::infinity()};
  };
